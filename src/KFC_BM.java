...
public class  KFC_BM extends JFrame implements ActionListener{
	...
	ImageIcon pc = new ImageIcon("img/d.png"); //Logo KFC-1
	ImageIcon pcc = new ImageIcon("img/e.png"); //Logo KFC-2
	ImageIcon pccc = new ImageIcon("img/f.png"); //Logo KFC-3
