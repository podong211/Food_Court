...
public class  KFC_Bev extends JFrame implements ActionListener{
	...
	ImageIcon pc = new ImageIcon("img/Bev.png"); //Logo KFC-1
	ImageIcon pcc = new ImageIcon("img/Bev1.png"); //Logo KFC-2
	ImageIcon pccc = new ImageIcon("img/Bev2.png"); //Logo KFC-3
