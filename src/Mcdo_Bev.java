...
public class   Mcdo_Bev extends JFrame implements ActionListener{
	...
	ImageIcon pc = new ImageIcon("img/hc1.png"); //Logo Mcdo-1
	ImageIcon pcc = new ImageIcon("img/sf1.png"); //Logo Mcdo-2
	ImageIcon pccc = new ImageIcon("img/pj1.png"); //Logo Mcdo-3
