...
public class Jobee_Gcash extends JFrame implements ActionListener{
	...
	public Jobee_Gcash() {
		...
		Rec.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				String msg = "<html> <center>Jollibee </center> <br> <center>GCASH PAYMENT </center> <br> <center>TIP FOODCOURT </center><br>"
    ...
    {
	 Jobee_Gcash Gcash = new Jobee_Gcash();
    }
	 @Override
	 public void actionPerformed(ActionEvent e) {
