...
public class Jobee_Paymaya extends JFrame implements ActionListener{
	...
	private final JLabel Title = new JLabel("PAYMAYA");
	...
	private final JLabel lblNewLabel = new JLabel("PAYMAYA METHOD");
	...
	private final JLabel lblNewLabel_1 = new JLabel("PAYMENT");
	private final JButton btnNewButton = new JButton("RETURN");
	
	
	public Jobee_Paymaya() {
		...
		Title.setBounds(210, 0, 293, 51);
		frame.getContentPane().add(Title);
		
		txtCash.setText("PAYMAYA");
		...
		lblNewLabel.setBounds(245, 225, 209, 49);
		...
		Rec.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				String msg = "<html> <center>Jollibee </center> <br> <center>PAYMAYA PAYMENT </center> <br> <center>TIP FOODCOURT </center><br>"
		...
		lblNewLabel_1.setFont(new Font("Adobe Arabic", Font.BOLD, 24));
		lblNewLabel_1.setHorizontalAlignment(SwingConstants.CENTER);
		lblNewLabel_1.setBounds(243, 29, 293, 51);
    ...
    {
	 Jobee_Paymaya Paymaya = new Jobee_Paymaya();
    }
	 @Override
	 public void actionPerformed(ActionEvent e) {
