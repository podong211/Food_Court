...
public class    Mcdo_Chicken extends JFrame implements ActionListener{
	...
	ImageIcon pc = new ImageIcon("img/hc111.png"); //Logo Mcdo-1
	ImageIcon pcc = new ImageIcon("img/sf111.png"); //Logo Mcdo-2
	ImageIcon pccc = new ImageIcon("img/pj111.png"); //Logo Mcdo-3
	
	JRadioButton CV1 = new JRadioButton("CV1");
	JRadioButton CV2 = new JRadioButton("CV2");
	private final JRadioButton CV3 = new JRadioButton("CV3");
	...
	public    Mcdo_Chicken() {
		...
		CV1.setFont(new Font("Times New Roman", Font.BOLD, 16));
		CV1.setForeground(Color.RED);
		CV1.setBackground(new Color(0xffac27));
		CV1.setHorizontalAlignment(SwingConstants.CENTER);
		CV1.setBounds(229, 257, 109, 23);
		frame.getContentPane().add(CV1);
		
		CV2.setHorizontalAlignment(SwingConstants.CENTER);
		CV2.setForeground(Color.RED);
		CV2.setBackground(new Color(0xffac27));
		CV2.setFont(new Font("Times New Roman", Font.BOLD, 16));
		CV2.setBounds(391, 257, 109, 23);
		frame.getContentPane().add(CV2);
		
		CV3.setForeground(Color.RED);
		CV3.setBackground(new Color(0xffac27));
		CV3.setHorizontalAlignment(SwingConstants.CENTER);
		CV3.setFont(new Font("Times New Roman", Font.BOLD, 16));
		CV3.setBounds(549, 257, 109, 23);
		
		frame.getContentPane().add(CV3);
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				if(CV1.isSelected()) {
					textField.setText(CV1.getText());
					Mcdo_Cart.Food_Code = textField.getText();
					int b1 = 144;
					...
					Mcdo_Cart.Qty = qt2;
					Mcdo_Cart.SubTotal = (b2 * qt2);
					JOptionPane.showMessageDialog(null,"ADD TO CART SUCCESSFULLY!");
					
				} else {
					textField.setText(CV3.getText());
					Mcdo_Cart.Food_Code = textField.getText();	
					int b3 = 110;
