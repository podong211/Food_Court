...
public class Mcdo_Paymaya extends JFrame implements ActionListener{
	...
	public Mcdo_Paymaya() {
		...
		Rec.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				String msg = "<html> <center>McDonald's </center> <br> <center>PAYMAYA PAYMENT </center> <br> <center>TIP FOODCOURT </center><br>"
