...
public class   Mcdo_Share extends JFrame implements ActionListener{
	...
	ImageIcon pc = new ImageIcon("img/hc11.png"); //Logo Mcdo-1
	ImageIcon pcc = new ImageIcon("img/sf11.png"); //Logo Mcdo-2
	ImageIcon pccc = new ImageIcon("img/pj11.png"); //Logo Mcdo-3
	
	JRadioButton MC1 = new JRadioButton("MC1");
	JRadioButton MC2 = new JRadioButton("MC2");
	private final JRadioButton MC3 = new JRadioButton("MC3");
	...
	public   Mcdo_Share() {
		...
		MC1.setFont(new Font("Times New Roman", Font.BOLD, 16));
		MC1.setForeground(Color.RED);
		MC1.setBackground(new Color(0xffac27));
		MC1.setHorizontalAlignment(SwingConstants.CENTER);
		MC1.setBounds(229, 257, 109, 23);
		frame.getContentPane().add(MC1);
		
		MC2.setHorizontalAlignment(SwingConstants.CENTER);
		MC2.setForeground(Color.RED);
		MC2.setBackground(new Color(0xffac27));
		MC2.setFont(new Font("Times New Roman", Font.BOLD, 16));
		MC2.setBounds(391, 257, 109, 23);
		frame.getContentPane().add(MC2);
		
		MC3.setForeground(Color.RED);
		MC3.setBackground(new Color(0xffac27));
		MC3.setHorizontalAlignment(SwingConstants.CENTER);
		MC3.setFont(new Font("Times New Roman", Font.BOLD, 16));
		MC3.setBounds(549, 257, 109, 23);
		
		frame.getContentPane().add(MC3);
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				} else 	if(MC2.isSelected()) {
					textField.setText(MC2.getText());
					Mcdo_Cart.Food_Code = textField.getText();	
					int b2 = 330;
