...
public class KFC_Paymaya extends JFrame implements ActionListener{
	...
	public KFC_Paymaya() {
		...
		TotalBill.setText(Integer.toString(KFC_Cart.getSum()));
		...
		Rec.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				String msg = "<html> <center>KFC </center> <br> <center>PAYMAYA PAYMENT </center> <br> <center>TIP FOODCOURT </center><br>"
