...
public class KFC_Gcash extends JFrame implements ActionListener{
	...
	public KFC_Gcash() {
		...
		Rec.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				String msg = "<html> <center>KFC </center> <br> <center>GCASH PAYMENT </center> <br> <center>TIP FOODCOURT </center><br>"
